...
botaoAddProduto.forEach(function(botao){
    ...
    botao.addEventListener('click', function(event){
        if(event.target.parentElement.classList.contains('store-item-icon')){
            ...
            // Enviando dados da imagem e preco dos produtos clicados para minha funcao
...
tratarCaminhoImagem = function(caminhoImagemCompleto){
    ...
    const caminhoReduzidoImagem = caminhoImagemCompleto.slice(indexCaminhoImagemCompleto);
    // console.log(caminhoReduzidoImagem);
